        ...
        <div class="modal-content">
                <div class="left">
                    <div class="row">
                        <div class="input">
                            ...
                            <input type="text" id="nome-docente">
                        </div>
                        <div class="input">
                    ...
                    <div class="row">
                        <div class="input">
                            ...
                            <input type="text" id="email-docente">
                        </div>
                        <div class="input">
                    ...
                    <div class="row">
                        <div class="input">
                            ...
                            <textarea id="motivo-requerimento" cols="80" rows="10"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="right">
                    <div class="input">                
                        ...
                        <input type="file" accept=".pdf" id="anexos">
                    </div>
                    <div class="input">
                        <label for="observacoes">Observações:</label>
                        <textarea id="observacoes" cols="20" rows="5"></textarea>
                    </div>
                    <div class="row">
